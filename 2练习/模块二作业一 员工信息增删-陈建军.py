...
def search():
    ...
    input_search = input('请输入查询语句:').strip()
    num1 = input_search[5:6]  # 截取*格式
    num2 = input_search[43:]   # 截取age>  "22"
    num3 = input_search[30:]  # 截取 "dept = 'IT'"
...
def delete():
    data_value = table_info()
    input_remove = input('请输入删除语句:').strip()
    # 取出ID号
...
def update():
    data_value = table_info()
    input_update = input('请输入修改语句:').strip()
